...
We were originally going to film a video which could have played in the powerpoint in order to show how a user would actually take a photo with the sytem, but we were unable to get it imbedded into the powerpoint. This cost us more time and was unfortunate, but we were able to find a different way to represent the photo taking process that works seemlessly and looks a lot like what it would have looked like if we had taken the actual video. Again using a peper prototype would have eliminated this issue, but finding a way to make it work was well worth it.
