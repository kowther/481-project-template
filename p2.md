...
__EVERYONE__
We found that having more brainstorming sessions would have been helpful to get more ideas. We also felt that having more of the funnelling effect would have been beneficial. Having just one brainstorming session and then going right into the storyboard and the video prototype didn't give us as much time as we would have liked to generate a lot of ideas and then refine them and then create more ideas based on those and then refine again. The brainstorming was very helpful in generating different types of idea... The affinity diagramming session helped us recognize the different visions that each group member had for different aspects of the system.
