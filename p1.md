...
![](https://github.com/kowther/FieldGuide-481/blob/master/interview03.jpg)

_Interviewees Alyssa and Wesley_

![](https://github.com/kowther/FieldGuide-481/blob/master/interview04.jpg)

_Interviewee Alyssa showing her favourite field guides_

![](https://github.com/kowther/FieldGuide-481/blob/master/interview05.jpg)

_Interviewer Stephanie and interviewee Alyssa_

Raw notes from interview:
* [Page 1](https://github.com/kowther/FieldGuide-481/blob/master/interview01.jpg)
* [Page 2](https://github.com/kowther/FieldGuide-481/blob/master/interview02.jpg)
...
Guides also vary widely in the way that plants are organized. One of Alyssa’s favourite books on plant identification had the plants organized in alphabetical order; another book that she liked had the plants organized by categories such as “medicinal.” She noted that alphabetical order is nice when she already knows what she’s looking for and just wants to learn more about it. Otherwise, she usually flips through the pages and looks at pictures/reads descriptions until finding something that seems right. I asked her what she might type into a Google search on her phone if she was outside and wanted to identify a flower, and she mentioned that a lot of people don’t exactly know what words to use to describe what they mean in the first place. Leaving users to come up with descriptive words on their own might lead them to struggle with inefficient searches. She said it would be nice if there was a way to apply filters that narrow down the possibilities (like when online shopping), so that users don’t have to worry as much about finding the right words to use since they would already be provided.
 
Alyssa also noted that guidebooks sometimes use inaccessible language. Wildlife authors with PhDs in the subject, for instance, may have a hard time realizing that language that makes perfect sense to them might not be as accessible to people without the same vocabulary and breadth of knowledge. For people without an academic background who interact with nature as a hobby, she noted that sometimes it can be difficult to find resources that contain accessible language.

 
### User Research Method 3: Extreme User Interviews

![](https://github.com/kowther/FieldGuide-481/blob/master/6.jpg)
_Entrance to Fish Creek Park, Bebo Grove_
![](https://github.com/kowther/FieldGuide-481/blob/master/5.jpg)
_Wildflower located in Fish Creek Park, Bebo Grove_
![](https://github.com/kowther/FieldGuide-481/blob/master/2.jpg)
_Interviewee Brent getting ready to use the Alberta Wildlife App_
![](https://github.com/kowther/FieldGuide-481/blob/master/1.jpg)
_Interviewee Brent correctly identified the Buffalo Bean Wildflower in Fish Creek Park_
![](https://github.com/kowther/FieldGuide-481/blob/master/3.jpg)
_Interviewee Lorraine getting ready to use the Alberta Wildlife App_
![](https://github.com/kowther/FieldGuide-481/blob/master/7.jpg)
